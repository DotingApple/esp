...
struct aesdecipher_v2_rtl_access aesdecipher_v2_cfg_000[] = {
	{
		/* <<--descriptor-->> */
		.aes_key_3 = AES_KEY_3,
		.aes_key_2 = AES_KEY_2,
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "aesdecipher_v2_rtl.0",
		.ioctl_req = AESDECIPHER_V2_RTL_IOC_ACCESS,
		.esp_desc = &(aesdecipher_v2_cfg_000[0].esp),
	}
};
