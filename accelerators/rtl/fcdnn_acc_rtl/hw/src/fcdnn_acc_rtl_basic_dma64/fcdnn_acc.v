...
module Core( 
	...
	input  wire        in_valid,   // 1-clock strobe when inputs are ready
    output wire        out_valid,  // 1-clock strobe when outputs match
	//controll inputs: ///////////////////////////////////////////////////////////
	...
	//////////////////////////////////////////////////////////////////////////////
	// =====================================================
	// ============  latency-matched valid flag  ============
	// =====================================================
	parameter int PIPE_DEPTH = 25;          // *** adjust if you change the pipeline
	reg [PIPE_DEPTH-1:0] valid_shift /* synthesis keep = 1 */;

	always @(posedge clk_pll) begin
		// shift left; LSB is newest value
		valid_shift <= { valid_shift[PIPE_DEPTH-2:0], in_valid };
	end

	assign out_valid = valid_shift[PIPE_DEPTH-1];
